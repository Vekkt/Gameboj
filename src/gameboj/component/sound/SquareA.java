...
//            short readBack = 0xFF;
//            switch(reg) {
//                case NR0: readBack = 0x80; break;
//                case NR1: readBack = 0x3F; break;
//                case NR2: readBack = 0x00; break;
//                case NR4: readBack = 0xBF; break;
//            }
    ...
    public void write(int address, int data) {
        ...
        if (inBounds(address, REGS_CH1_START, REGS_CH1_END)) {
            System.out.println(String.format("Writing at SQ1 @0x%x = 0x%x", address, data));
